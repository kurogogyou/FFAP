...
foc05.products.create!( 
	...
	image_url: 'Ford Focus/Ford Focus 2008 Bonete.PNG',  
	brand_id: ford.id) 
foc05.products.create!( 
	title: 'Bumper Delantero Ford Focus 05', 
	description:  
		'Bumper Delantero Ford Focus 2005', 
	image_url: 'Ford Focus/Ford Focus 2008 Bumper Delantero.PNG', 
	brand_id: ford.id) 
foc05.products.create!( 
	title: 'Bumper Trasero Ford Focus 05', 
	description:  
		'Bumper Trasero Ford Focus 2005', 
	image_url: 'Ford Focus/Ford Focus 2008 Bumper Trasero.PNG', 
	brand_id: ford.id) 
foc05.products.create!( 
	title: 'Halogenos Ford Focus 05', 
	description:  
		'Halogenos Ford Focus 2005', 
	image_url: 'Ford Focus/Ford Focus 2008 Halogenos.PNG', 
	brand_id: ford.id) 
foc05.products.create!( 
	title: 'Luz Delantera Ford Focus 05', 
	description:  
		'Luz Delantera Ford Focus 2005', 
	image_url: 'Ford Focus/Ford Focus 2008 Luz Delantera.PNG', 
	brand_id: ford.id) 
foc05.products.create!( 
	title: 'Luz Trasera Ford Focus 05', 
	description:  
		'Luz Trasera Ford Focus 2005', 
	image_url: 'Ford Focus/Ford Focus 2008 Luz Trasera.PNG', 
	brand_id: ford.id) 
foc05.products.create!( 
	title: 'Parrilla Ford Focus 05', 
	description:  
		'Parrilla Ford Focus 2005', 
	image_url: 'Ford Focus/Ford Focus 2008 Parrilla.PNG', 
	brand_id: ford.id) 
foc05.products.create!( 
	title: 'Retrovisor Ford Focus 05', 
	description:  
		'Retrovisor Ford Focus 2005', 
	image_url: 'Ford Focus/Ford Focus 2008 Retrovisor.PNG',  
	brand_id: ford.id) 
