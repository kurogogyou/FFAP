...
ecl00.products.create!( 
	...
	seed_image: 'Mitsubishi Eclipse 00/Mitsubishi Eclipse 00 Aros.PNG', 
	brand_id: mitsubishi.id) 
ecl00.products.create!( 
	title: 'Bonete Mitsubishi Eclipse 00', 
	description:  
		'Bonete Mitsubishi Eclipse 2000', 
	seed_image: 'Mitsubishi Eclipse 00/Mitsubishi Eclipse 00 Bonete.PNG', 
	# price: 6600, 
	brand_id: mitsubishi.id) 
ecl00.products.create!( 
	...
	seed_image: 'Mitsubishi Eclipse 00/Mitsubishi Eclipse 00 Bumper Delantero.PNG', 
	# price: 3800, 
	brand_id: mitsubishi.id) 
ecl00.products.create!( 
	...
	seed_image: 'Mitsubishi Eclipse 00/Mitsubishi Eclipse 00 Bumper Trasero.PNG', 
	# price: 4400, 
	brand_id: mitsubishi.id) 
ecl00.products.create!( 
	...
	seed_image: 'Mitsubishi Eclipse 00/Mitsubishi Eclipse 00 Halogenos.PNG', 
	# price: 1500, 
	brand_id: mitsubishi.id) 
ecl00.products.create!( 
	...
	seed_image: 'Mitsubishi Eclipse 00/Mitsubishi Eclipse 00 Luz Delantera.PNG', 
	# price: 2000, 
	brand_id: mitsubishi.id) 
ecl00.products.create!( 
	...
	seed_image: 'Mitsubishi Eclipse 00/Mitsubishi Eclipse 00 Luz Trasera.PNG', 
	# price: 2100, 
	brand_id: mitsubishi.id) 
ecl00.products.create!( 
	...
	seed_image: 'Mitsubishi Eclipse 00/Mitsubishi Eclipse 00 Retrovisor.PNG', 
	# price: 2100, 
	brand_id: mitsubishi.id) 
...
lan07.products.create!( 
	...
	seed_image: 'Mitsubishi Lancer 08/Mitsubishi Lancer 08 Aros.PNG', 
	brand_id: mitsubishi.id) 
lan07.products.create!( 
	title: 'Bonete Mitsubishi Lancer 07', 
	description:  
		'Bonete Mitsubishi Lancer 2007', 
	seed_image: 'Mitsubishi Lancer 08/Mitsubishi Lancer 08 Bonete.PNG', 
	# price: 6600, 
	brand_id: mitsubishi.id) 
lan07.products.create!( 
	...
	seed_image: 'Mitsubishi Lancer 08/Mitsubishi Lancer 08 Bumper Delantero.PNG', 
	# price: 3800, 
	brand_id: mitsubishi.id) 
lan07.products.create!( 
	...
	seed_image: 'Mitsubishi Lancer 08/Mitsubishi Lancer 08 Halogenos.PNG', 
	# price: 1500, 
	brand_id: mitsubishi.id) 
lan07.products.create!( 
	...
	seed_image: 'Mitsubishi Lancer 08/Mitsubishi Lancer 08 Luz Delantera.PNG', 
	# price: 2000, 
	brand_id: mitsubishi.id) 
lan07.products.create!( 
	...
	seed_image: 'Mitsubishi Lancer 08/Mitsubishi Lancer 08 Luz Trasera.PNG', 
	# price: 2100, 
	brand_id: mitsubishi.id) 
lan07.products.create!( 
	...
	seed_image: 'Mitsubishi Lancer 08/Mitsubishi Lancer 08 Parrilla.PNG', 
	# price: 1800, 
	brand_id: mitsubishi.id) 
lan07.products.create!( 
	...
	seed_image: 'Mitsubishi Lancer 08/Mitsubishi Lancer 08 Retrovisor.PNG', 
	# price: 2100, 
	brand_id: mitsubishi.id) 
