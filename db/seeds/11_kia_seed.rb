...
opt05.products.create!( 
	...
	image_url: 'Kia Optima/Kia Optima 2005 Bonete.PNG',  
	brand_id: Kia.id) 
opt05.products.create!( 
	title: 'Bumper Delantero Kia Optima 05', 
	description:  
		'Bumper Delantero Kia Optima 2005', 
	image_url: 'Kia Optima/Kia Optima 2005 Bumper Delantero.PNG', 
	brand_id: Kia.id) 
...
opt05.products.create!( 
	...
	image_url: 'Kia Optima/Kia Optima 2005 Halogenos.PNG', 
	brand_id: Kia.id) 
opt05.products.create!( 
	title: 'Luz Delantera Kia Optima 05', 
	description:  
		'Luz Delantera Kia Optima 2005', 
	image_url: 'Kia Optima/Kia Optima 2005 Luz Delantera.PNG', 
	brand_id: Kia.id) 
opt05.products.create!( 
	title: 'Luz Trasera Kia Optima 05', 
	description:  
		'Luz Trasera Kia Optima 2005', 
	image_url: 'Kia Optima/Kia Optima 2005 Luz Trasera.PNG', 
	brand_id: Kia.id) 
opt05.products.create!( 
	title: 'Retrovisor Kia Optima 05', 
	description:  
		'Retrovisor Kia Optima 2005', 
	image_url: 'Kia Optima/Kia Optima 2005 Retrovisor.PNG',  
	brand_id: Kia.id) 
...
spo04.products.create!( 
	...
	image_url: 'Kia Sportage/Kia Sportage 2005 Bumper Delantero.PNG', 
	brand_id: Kia.id) 
spo04.products.create!( 
	title: 'Bumper Trasero Kia Sportage', 
	description:  
		'Bumper Trasero Kia Sportage 2004', 
	image_url: 'Kia Sportage/Kia Sportage 2005 Bumper Trasero.PNG', 
	brand_id: Kia.id) 
spo04.products.create!( 
	title: 'Halogenos Kia Sportage', 
	description:  
		'Halogenos Kia Sportage 2004', 
	image_url: 'Kia Sportage/Kia Sportage 2005 Halogenos.PNG', 
	brand_id: Kia.id) 
spo04.products.create!( 
	title: 'Luz Delantera Kia Sportage', 
	description:  
		'Luz Delantera Kia Sportage 2004', 
	image_url: 'Kia Sportage/Kia Sportage 2005 Luz Delantera.PNG',  
	brand_id: Kia.id) 
spo04.products.create!( 
	title: 'Luz Trasera Kia Sportage', 
	description:  
		'Luz Trasera Kia Sportage 2004', 
	image_url: 'Kia Sportage/Kia Sportage 2005 Luz Trasera.PNG', 
	brand_id: Kia.id) 
spo04.products.create!( 
	title: 'Retrovisor Kia Sportage', 
	description:  
		'Retrovisor Kia Sportage 2004', 
	image_url: 'Kia Sportage/Kia Sportage 2005 Retrovisor.PNG', 
	brand_id: Kia.id) 
